...
class PlayersEditTest < ActionDispatch::IntegrationTest
  ...
  test "unsuccessful edit" do
    ...
    patch player_path(@player), player: { name: "", email: "foo@invalid", password: "foo", password_confirmation: "bar" }
    assert_template 'players/edit'
  end
  ...
  test "successful edit with friendly forwarding" do
    ...
    name = "Foo Bar"
    email = "foo@bar.com"
    patch player_path(@player), player: { name: name, email: email, password: "", password_confirmation: "" }
